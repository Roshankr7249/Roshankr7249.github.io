    ...
    <nav id="nav-menu" onClick={handleClick}>
      <div id="logo-nav">
        ...
        <div className="ham-container">
          ...
          download={'Roshan_Kumar_Resume.pdf'} className="contact-button resume-button first-btn">
            Resume
          </a>
          <span className="ham">
      ...
      href={resume} 
      onClick={handleDownload} 
      rel="noreferrer" download={'Roshan_Kumar_Resume.pdf'} id="resume-button-1" className="contact-button nav-link resume resume-button second-btn">
        Resume</a>
    </nav>
  );
}
